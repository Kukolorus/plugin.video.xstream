...
def checkSettings():
    ...
    oSettingsHandler.addText('download_settings', 'jd_host', '30072', default='127.0.0.1', enable='!eq(-1,false)')
    oSettingsHandler.addText('download_settings', 'jd_port', '30073', default='10025', enable='!eq(-2,false)')
    ...
    oSettingsHandler.addLabelSeperator('download_settings', 'PyLoad')
    oSettingsHandler.addBool('download_settings', 'pyload_enabled', '30082', 'false')
    oSettingsHandler.addText('download_settings', 'pyload_host', '30072', default='127.0.0.1', enable='!eq(-1,false)')
    oSettingsHandler.addText('download_settings', 'pyload_port', '30073', default='8000', enable='!eq(-2,false)')
    ...
    # Site updater
    oSettingsHandler = plugins.getUpdaterSettings(oSettingsHandler)
