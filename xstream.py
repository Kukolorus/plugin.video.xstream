...
def checkSettings():
    ...
    oSettingsHandler.addBool('main_settings', 'hosterListFolder', '30007', 'false', enable='eq(-2,false)')
    oSettingsHandler.addBool('main_settings', 'presortHoster', '30009', 'true', enable='eq(-3,false)')
    ...
    oSettingsHandler.addBool('main_settings', 'metaOverwrite', '30008', 'false', enable='eq(-1,false)')
    ...
    oSettingsHandler.addNumber('view_settings', 'movies-view', 'Film-View', '503', enable='eq(-1,false)')
    oSettingsHandler.addNumber('view_settings', 'tvshow-view', 'Serien-View', '503', enable='eq(-1,false)')
    oSettingsHandler.addNumber('view_settings', 'seasons-view', 'Staffel-View', '504', enable='eq(-1,false)')
    oSettingsHandler.addNumber('view_settings', 'episodes-view', 'Episoden-View', '504', enable='eq(-1,false)')
    ...
    oSettingsHandler.addBool('download_settings', 'jd_automatic_start', '30074', 'true', enable='!eq(-3,false)')
    oSettingsHandler.addBool('download_settings', 'jd_grabber', '30075', 'false', enable='!eq(-4,false)')
    oSettingsHandler.addSeperator('download_settings')
    oSettingsHandler.addBool('download_settings', 'pyload_enabled', '30082', 'false')
    oSettingsHandler.addText('download_settings', 'pyload_host', '30072', '127.0.0.1', enable='!eq(-1,false)')
    oSettingsHandler.addText('download_settings', 'pyload_port', '30073', '8000', enable='!eq(-2,false)')
    oSettingsHandler.addText('download_settings', 'pyload_user', '30083', '', enable='!eq(-3,false)')
    oSettingsHandler.addText('download_settings', 'pyload_passwd', '30084', 'hidden', '', enable='!eq(-4,false)')
